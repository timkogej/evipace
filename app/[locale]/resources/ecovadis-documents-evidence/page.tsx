...
import { ecovadisDocumentsEvidenceContent } from "@/components/evipace/resources/english-batch1-content";
...
const ARTICLE_HEADLINE =
  "EcoVadis documents and evidence: what suppliers should prepare.";
const ARTICLE_PATH = "/en/resources/ecovadis-documents-evidence";
...
export default async function EcovadisDocumentsEvidencePage({
  params
}: PageProps) {
  const { locale } = await params;
  ...
  return (
    <>
      ...
      <EnglishResourceArticle content={ecovadisDocumentsEvidenceContent} />
    </>
  );
}
