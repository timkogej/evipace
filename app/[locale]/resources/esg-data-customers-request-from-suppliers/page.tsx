...
import { esgDataCustomersRequestContent } from "@/components/evipace/resources/english-batch1-content";
...
const ARTICLE_HEADLINE = "What ESG data do customers ask suppliers for?";
const ARTICLE_PATH =
...
export default async function EsgDataCustomersRequestPage({
  params
}: PageProps) {
  const { locale } = await params;
  ...
  return (
    <>
      ...
      <EnglishResourceArticle content={esgDataCustomersRequestContent} />
      <PreparedBy
