...
import { esgDataOwnersContent } from "@/components/evipace/resources/english-batch2-content";
...
const ARTICLE_HEADLINE = "Who owns ESG data inside the company?";
const ARTICLE_PATH = "/en/resources/esg-data-owners";
...
export default async function EsgDataOwnersPage({ params }: PageProps) {
  const { locale } = await params;
  ...
  return (
    <>
      ...
      <EnglishResourceArticle content={esgDataOwnersContent} />
    </>
  );
}
