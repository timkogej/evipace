...
import { EnglishQuestionnaireChecklistGuide } from "@/components/evipace/resources/EnglishInteractiveResourceGuides";
...
const ARTICLE_HEADLINE = "ESG Questionnaire Checklist for Suppliers";
const ARTICLE_PATH = "/en/resources/esg-questionnaire-checklist";
...
export default async function EnglishQuestionnaireChecklistPage({
  params
}: PageProps) {
  const { locale } = await params;
  ...
  return (
    <>
      ...
      <EnglishQuestionnaireChecklistGuide />
    </>
  );
}
