...
import { EcovadisDocumentsGuide } from "@/components/evipace/resources/EcovadisDocumentsGuide";
...
const ARTICLE_PATH = "/de/ressourcen/ecovadis-dokumente-nachweise";
...
export default async function EcovadisDocumentsResourcePage({
  params
}: PageProps) {
  const { locale } = await params;
