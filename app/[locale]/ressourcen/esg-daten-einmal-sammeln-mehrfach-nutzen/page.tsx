...
import { EsgReusableDataGuide } from "@/components/evipace/resources/EsgReusableDataGuide";
...
export default async function EsgReusableDataResourcePage({
  params
}: PageProps) {
  const { locale } = await params;
  ...
  const schemaGraph = [
    ...
    buildBreadcrumbListSchema([
      ...
      { name: "ESG-Daten einmal sammeln, mehrfach nutzen", path: ARTICLE_PATH }
    ])
