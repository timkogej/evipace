...
import { EsgQuestionnaireChecklistGuide } from "@/components/evipace/resources/EsgQuestionnaireChecklistGuide";
...
const ARTICLE_HEADLINE = "ESG-Fragebogen Checkliste für Lieferanten";
const ARTICLE_PATH =
...
export default async function EsgQuestionnaireChecklistResourcePage({
  params
}: PageProps) {
  const { locale } = await params;
  ...
  return (
    <>
      ...
      <EsgQuestionnaireChecklistGuide />
    </>
  );
}
