...
import { EsgEvidenceGuide } from "@/components/evipace/resources/EsgEvidenceGuide";
...
const ARTICLE_PATH = "/de/ressourcen/esg-nachweise-lieferanten";
...
export default async function EsgEvidenceResourcePage({ params }: PageProps) {
  const { locale } = await params;
