...
import { IntegrityNextInvitationGuide } from "@/components/evipace/resources/IntegrityNextInvitationGuide";
...
const ARTICLE_PATH = "/de/ressourcen/integritynext-einladung-lieferanten";
...
export default async function IntegrityNextInvitationResourcePage({
  params
}: PageProps) {
  const { locale } = await params;
