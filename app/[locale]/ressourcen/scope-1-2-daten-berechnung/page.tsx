...
import { Scope12DataGuide } from "@/components/evipace/resources/Scope12DataGuide";
...
const ARTICLE_PATH = "/de/ressourcen/scope-1-2-daten-berechnung";
...
export default async function Scope12DataResourcePage({ params }: PageProps) {
  const { locale } = await params;
