...
import { SupplierCodeOfConductGuide } from "@/components/evipace/resources/SupplierCodeOfConductGuide";
...
const ARTICLE_PATH = "/de/ressourcen/supplier-code-of-conduct-erstellen";
...
export default async function SupplierCodeResourcePage({
  params
}: PageProps) {
  const { locale } = await params;
  ...
  const schemaGraph = [
    ...
    buildBreadcrumbListSchema([
      ...
      { name: "Supplier Code of Conduct erstellen", path: ARTICLE_PATH }
    ])
