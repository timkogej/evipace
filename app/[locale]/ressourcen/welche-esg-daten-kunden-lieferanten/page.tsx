...
import { EsgCustomerDataGuide } from "@/components/evipace/resources/EsgCustomerDataGuide";
...
export default async function EsgCustomerDataResourcePage({
  params
}: PageProps) {
  const { locale } = await params;
